//------------------------------------------------------------------+
// PCM. Procesamiento Paralelo  Curso 14/15 EUI           24/04/15  |
//                                                                  |
// sumVectorBis.cu: Prueba de suma de un vector en la GPU usando    |
...
__global__ void sumVectorKernel (double *Ad, double *Bd) {
  ...
  for (salto = anchoBloque / 2; salto > 0; salto /= 2) {
...
int main (int argc, char *argv[])
{
  ...
  numBloques = cardinalidadVector / anchoBloque;
