...
int main (int argc, char *argv[])
{
  ...
  cudaMallocManaged(&C,sizeVectorEnBytes);
  //tiempos de alocación
  ...
  sumVectorKernel<<<cardinalidadVector/anchoBloque, anchoBloque>>>(A, B, C);
