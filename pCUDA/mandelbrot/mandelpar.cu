...
//                    VERSION CUDA                                  |
//                                                                  |
// mandelpar.c: Programa que pinta el conjunto de Mandelbrot al     |
...
static int *colores, *coloresd; // Matrices para colores fractal
static int sizeColores;

//------------------------------------------------------------------+
// plano2D    Implementacion del modulo que correlaciona ventana    |
//------------------------------------------------------------------+
